...
M.general = {
  n = {
    ...
    -- Copy all
    ['<leader>fc'] = { '<cmd> %y+ <CR>', 'Copy whole file' },
    ...
    -- new buffer
    ['<leader>wn'] = { '<cmd> enew <CR>', 'New buffer' },
...
M.nvimtree = {
  ...
  n = {
    ...
    -- focus
    ['<leader>ff'] = { '<cmd> NvimTreeFocus <CR>', 'Focus nvimtree' },
  },
}
...
M.telescope = {
  ...
  n = {
    ...
    ['<leader>tB'] = { '<cmd> Telescope marks <CR>', 'telescope bookmarks' },
  },
}
